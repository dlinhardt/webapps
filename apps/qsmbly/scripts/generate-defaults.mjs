...
const defaults = {
  ...
  NDI_DEFAULTS: JSON.parse(wasmModule.get_ndi_defaults()),
  FANSI_DEFAULTS: JSON.parse(wasmModule.get_fansi_defaults()),
  L1QSM_DEFAULTS: JSON.parse(wasmModule.get_l1qsm_defaults()),
